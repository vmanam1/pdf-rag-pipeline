...
mapping_file = os.path.join(
    str(BASE_DIR),
    "faiss_storage",
    "embeddings_with_vectors.json"
)

papers_data_json = os.path.join(
    str(BASE_DIR),
    "pdf_scraping",
    "combined_data.json"
)
...
def search_similar_papers(query_vector,k=5):
    ...
    # Retrieve the actual content of the similar papers/sections
    all_content = []
    ...
    for i, result in enumerate(similar_papers, 1):
        ...
        if section_name == "abstract":
            ...
            content = papers_data[paper_id]["sections"].get(
                section_name,
                "Section not found"
            )

        print(
            f"Rank {i}: Paper ID: {paper_id}, "
